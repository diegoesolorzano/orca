...
import { wireTimeTracker } from './time-tracker/wire'
...
app.on('before-quit', () => {
  ...
  // it to confirm Cmd+Q, and a cancelled quit clears it via onQuitAborted. All
  // service teardown moved to will-quit so a cancelled Cmd+Q leaves the app
  // fully functional instead of silently disabling relay/rate-limits/agent-awake.
