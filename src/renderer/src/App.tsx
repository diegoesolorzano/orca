...
import { useTimeTrackerActivity } from './hooks/useTimeTrackerActivity'
...
function App(): React.JSX.Element {
  ...
  // Fork feature: human time tracking — reports throttled activity to main.
  useTimeTrackerActivity()
