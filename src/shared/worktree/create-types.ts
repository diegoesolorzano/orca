...
// Why (fork): a worktree of a meta-repo (parent repo containing independent nested git
// repos) materializes none of the nested repos' files; this warns the user post-create
// instead of leaving them in a silently incomplete tree.
